...
function Update () {
	...
	rigidbody.velocity.x = transform.forward.x * Speed * Time.deltaTime;
    rigidbody.velocity.z = transform.forward.z * Speed * Time.deltaTime;
    rigidbody.velocity.y = transform.forward.y * Speed * Time.deltaTime;

    rigidbody.velocity.x += Random.Range(-Noise.x,Noise.x);
    rigidbody.velocity.z += Random.Range(-Noise.z,Noise.z);
    rigidbody.velocity.y += Random.Range(-Noise.y,Noise.y);
