...
public class NgAtlas
{
	...
	public static NcSpriteFactory.NcFrameInfo[] TileToTrimTexture(Material tarMat, int nTileX, int nTileY, int nStartFrame, int nFrameCount, int nMaxAtlasTextureSize)
	{
		...
		bool							bFindAlpha;
		bool							bFindBlack;
		NcSpriteFactory.NcFrameInfo[]	frameInfos		= NgAtlas.TrimTexture(tileTexture, true, true, nTileX, nTileY, nStartFrame, nFrameCount, ref frameTextures, out bFindAlpha, out bFindBlack);
	...
	public static string ExportSplitTexture(string tarBasePath, Texture srcTex, int nTileX, int nTileY, int nStartFrame, int nFrameCount)
	{
		...
		bool							bFindAlpha;
		bool							bFindBlack;
		NcSpriteFactory.NcFrameInfo[]	frameInfos		= NgAtlas.TrimTexture(tileTexture, false, false, nTileX, nTileY, nStartFrame, nFrameCount, ref frameTextures, out bFindAlpha, out bFindBlack);
